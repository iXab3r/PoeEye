...
{
    [UsedImplicitly]
    internal sealed class PoeBudBootstrapper : DisposableReactiveObject
    {
        ...
        private readonly IFactory<PoeBudViewModel, IOverlayWindowController> viewModelFactory;

        public PoeBudBootstrapper(
            ...
            [NotNull] IFactory<PoeBudViewModel, IOverlayWindowController> viewModelFactory,
