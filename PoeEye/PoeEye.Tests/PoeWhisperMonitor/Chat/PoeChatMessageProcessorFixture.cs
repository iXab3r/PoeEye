    ...
    public class PoeChatMessageProcessorFixture
    {
        ...
        private IEnumerable<TestCaseData> ShouldParseCases()
        {
            yield return new TestCaseData(
                ...
                new PoeMessage()
                {
                    Message = "Hi, I would like to buy your Storm Eye Paua Ring listed for 300 chaos in Legacy (stash tab \"~b / o 2 chaos\"; position: left 2, top 2)",
            ...
            yield return new TestCaseData(
                ...
                new PoeMessage()
                {
                    Message = "Hi, I would like to buy your Golem Nails Gripped Gloves listed for 1.5 exalted in Legacy (stash tab \"$\"; position: left 0, top 0)",
                    MessageType = PoeMessageType.WhisperOutgoing,
