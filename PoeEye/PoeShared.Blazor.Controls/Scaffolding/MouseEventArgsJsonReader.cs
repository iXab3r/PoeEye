...
public static class MouseEventArgsJsonReader
{
    ...
    public static MouseEventArgs Read(JsonElement jsonElement)
    {
    ...
    public static void ReadProperty(MouseEventArgs eventArgs, JsonProperty property)
    {
