...
internal partial class BlazorWindow
{
    private sealed class NativeWindow : ReactiveForm
    {
        ...
        {
            var displayMode = titleBarDisplayMode.ResolveForWinForms();
        ...
        {
            var displayMode = owner.TitleBarDisplayMode.ResolveForWinForms();
        ...
        {
            if (owner.TitleBarDisplayMode.ResolveForWinForms() == TitleBarDisplayMode.System && allowsTransparency)
            {
            ...
            TrySetAllowsTransparency(allowsTransparency, owner.TitleBarDisplayMode.ResolveForWinForms());
        }
