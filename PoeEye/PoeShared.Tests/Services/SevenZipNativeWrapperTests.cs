...
[TestFixture]
public class SevenZipNativeWrapperTests : FixtureBase
{
    private static readonly string TempFolderName = nameof(SevenZipNativeWrapperTests);
    ...
    private SevenZipNativeWrapper CreateInstance()
    {
        return Container.Build<SevenZipNativeWrapper>().Create();
    }
}