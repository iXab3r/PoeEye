...
public sealed class Phase2BlazorCounterSmokeTests
{
    [Fact]
    public async Task BlazorCounterPageRendersAndRespondsToClick()
    {
        ...
        await BlazorCounterHarness.AssertBasicCounterBehaviorAsync(page);
    }
