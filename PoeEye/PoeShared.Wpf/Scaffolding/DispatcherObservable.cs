...
public static class DispatcherObservable
{
    ...
    /// <summary>
    /// Alias for ObserveOnDispatcher
    /// </summary>
    /// <typeparam name="TSource"></typeparam>
    /// <param name="source"></param>
    /// <returns></returns>
    public static IObservable<TSource> ObserveOnCurrentDispatcher<TSource>(this IObservable<TSource> source)
    {
        return ObserveOnDispatcher(source);
    }
