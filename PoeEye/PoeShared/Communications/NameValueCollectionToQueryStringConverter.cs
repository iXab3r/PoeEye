...
{
    internal sealed class NameValueCollectionToQueryStringConverter : IConverter<NameValueCollection, string>, IConverter<NameValueCollection, IEnumerable<KeyValuePair<string, string>>> 
    {
