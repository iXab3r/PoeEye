...
internal sealed class Factory<TOut, TIn1, TIn2, TIn3, TIn4> : IFactory<TOut, TIn1, TIn2, TIn3, TIn4>
{
    ...
    public TOut Create(TIn1 param1, TIn2 param2, TIn3 param3, TIn4 param4)
    {
