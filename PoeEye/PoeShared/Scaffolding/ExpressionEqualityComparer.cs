...
///     This is copied from EFCore to avoid bringing all EF dependencies along with it: https://github.com/dotnet/efcore/blob/8e675829631dc49c284a779c86c2eab1d742f729/src/EFCore/Query/ExpressionEqualityComparer.cs
/// </summary>
/// <remarks>
    ...
    private struct ExpressionComparer
    {
        ...
        private bool CompareLambda(LambdaExpression a, LambdaExpression b)
        {
            ...
            for (var i = 0; i < n; i++)
            {
                ...
                {
                    throw new InvalidOperationException($"The same parameter instance with name '{p1.Name}' was used in multiple lambdas in the query tree. Each lambda must have its own parameter instances.");
                }
            }
