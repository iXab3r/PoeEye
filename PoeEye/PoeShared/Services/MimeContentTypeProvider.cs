...
public sealed class MimeContentTypeProvider : LazyReactiveObject<MimeContentTypeProvider>
{
    // ReSharper disable StringLiteralTypo
    private static readonly Dictionary<string, string> MimeTypeByExtension = new(StringComparer.OrdinalIgnoreCase)
    {
        {".323", "text/h323"},
        {".3g2", "video/3gpp2"},
        {".3gp2", "video/3gpp2"},
    ...
    public bool TryGetContentType(string path, out MimeContentType? contentType)
    {
        ...
        if (!MimeTypeByExtension.TryGetValue(path, out var contentTypeString))
        {
            contentType = null;
            return false;
        }
