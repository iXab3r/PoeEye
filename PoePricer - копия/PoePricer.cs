...
namespace PoePricer
{
    ...
    public class PoePricer 
    {
      ...
      /*  static void Main()
        ...
        public void CreateTooltip(string itemData)
        {
            var item = new Item();
            item.ParseItemDataText(itemData, KnownAffixBrackets, KnownBaseItems, KnownAffixes, KnownRegexes);
            FilterTypes type;
        ...
        public void ShowToolTip(int coorX = 1200, int coorY = 0)
        {
            _tt.ShowForm(coorX, coorY);
        }
